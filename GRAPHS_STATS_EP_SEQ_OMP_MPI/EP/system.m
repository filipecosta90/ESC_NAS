...
xlabel('Tempo (s)');
l = legend('System INT - EP - SEQ','System INT - EP - OMP','System INT - EP - MPI','System CSW - EP - SEQ','System CSW - EP - OMP','System CSW - EP - MPI');

title({'System Stats, kernel EP, Tempo entre [0,18]'},'interpreter','latex')
...
title({'System Stats, kernel EP'},'interpreter','latex')
