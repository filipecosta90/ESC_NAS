...
cg_c_431_gnu = csvread('__compare/COMPARATION_431_is__C__GNU.csv');
cg_c_431_gnu_mx = csvread('__compare/COMPARATION_431_is__C__GNU_MX.csv');
cg_c_431_intel = csvread('__compare/COMPARATION_431_is__C__INTEL.csv');
cg_c_431_intel_mx = csvread('__compare/COMPARATION_431_is__C__INTEL_MX.csv');
...
t = title({'Rela\c{c}\~ao entre Tempo Total em segundos para o kernel MPI - IS, nodos 431 ','Classe de dados C para compiladores gcc 4.9.0 e icc 13.0.1 com flag de compila\c{c}\~ao -O3','Para comunica\c{c}\~ao Gigabit Ethernet e Myrinet 10Gbps'},'interpreter','latex')
