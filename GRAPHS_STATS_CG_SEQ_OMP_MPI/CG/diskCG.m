...
xlabel('Tempo (s)');
l = legend('Disk READ - CG - SEQ','Disk READ - CG - OMP','Disk READ - CG - MPI','Disk WRITE - CG - SEQ','Disk WRITE - CG - OMP','Disk WRITE - CG - MPI');

title({'Disk Stats, kernel CG, Tempo entre [0,40]'},'interpreter','latex')
...
title({'Disk Stats, kernel CG'},'interpreter','latex')
