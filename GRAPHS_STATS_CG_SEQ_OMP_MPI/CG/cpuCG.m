...
ylabel('Percentagem');
xlabel('Tempo (s)');
l = legend('% CPU USR - CG - SEQ','% CPU USR - CG - OMP','% CPU USR - CG - MPI' );

title({'CPU Stats, kernel CG, Tempo entre [0,40]'},'interpreter','latex')
...
title({'CPU Stats, kernel CG'},'interpreter','latex')
