...
xlabel('Tempo (s)');
l = legend('MEMORY USED - CG - SEQ','MEMORY USED - CG - OMP','MEMORY USED - CG - MPI' );

title({'Memory Stats, kernel CG, Tempo entre [0,40]'},'interpreter','latex')
...
title({'Memory Stats, kernel CG'},'interpreter','latex')
