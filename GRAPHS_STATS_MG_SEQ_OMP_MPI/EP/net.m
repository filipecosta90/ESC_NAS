...
xlabel('Tempo (s)');
l = legend('NET Receive - EP - SEQ','NET Receive - EP - OMP','NET Receive - EP - MPI','NET Send - EP - SEQ','NET Send - EP - OMP','NET Send - EP - MPI');

title({'Net Stats, kernel EP, Tempo entre [0,18]'},'interpreter','latex')
...
title({'Net Stats, kernel EP'},'interpreter','latex')
