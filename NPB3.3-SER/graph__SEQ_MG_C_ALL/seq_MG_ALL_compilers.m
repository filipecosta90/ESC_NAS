...
x = [1:4];
gnu_6_0 = csvread('COMPARATION_mg__C_bin_gnu_4.4.6_O0.csv');
gnu_6_2 = csvread('COMPARATION_mg__C_bin_gnu_4.4.6_O2.csv');
gnu_6_3 = csvread('COMPARATION_mg__C_bin_gnu_4.4.6_O3.csv');
gnu_9_0 = csvread('COMPARATION_mg__C_bin_gnu_4.9.0_O0.csv');
gnu_9_2 = csvread('COMPARATION_mg__C_bin_gnu_4.9.0_O2.csv');
gnu_9_3 = csvread('COMPARATION_mg__C_bin_gnu_4.9.0_O3.csv');
intel_0 = csvread('COMPARATION_mg__C_bin_intel_13.0.1_O0.csv');
intel_2 = csvread('COMPARATION_mg__C_bin_intel_13.0.1_O2.csv');
intel_3 = csvread('COMPARATION_mg__C_bin_intel_13.0.1_O3.csv');
